...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2024 at 08:56 PM
...
('root', '[{\"db\":\"sagss\",\"table\":\"lockers\"},{\"db\":\"sagss\",\"table\":\"foodmenu\"},{\"db\":\"sagss\",\"table\":\"locker_mapping\"},{\"db\":\"sagss\",\"table\":\"food_mapping\"},{\"db\":\"sagss\",\"table\":\"meetings\"},{\"db\":\"sagss\",\"table\":\"meeting_room\"},{\"db\":\"sagss\",\"table\":\"users\"}]');
...
('root', 'sagss', 'food_mapping', '{\"sorted_col\":\"`food_mapping`.`price` ASC\"}', '2024-04-20 09:53:41'),
('root', 'sagss', 'meetings', '{\"CREATE_TIME\":\"2024-04-20 22:59:16\"}', '2024-04-20 17:46:20');
...
('root', '2024-04-20 18:56:10', '{\"Console\\/Mode\":\"show\",\"Console\\/Height\":-47.01360000000001}');
...
-- Database: `sagss`
--
CREATE DATABASE IF NOT EXISTS `sagss` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sagss`;
...
(2, '{\'2\': \'2\', \'3\': \'1\', \'total\': \'280.00\'}', 280, '2024-04-20'),
(2, '{\'2\': \'2\', \'3\': \'1\', \'total\': \'280.00\'}', 280, '2024-04-20'),
(2, '{\'2\': \'2\', \'3\': \'0\', \'total\': \'200.00\'}', 200, '2024-04-20');
